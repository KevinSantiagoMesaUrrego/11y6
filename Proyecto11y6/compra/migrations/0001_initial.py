    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_compra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='compra.compra', verbose_name='Fecha de Compra')),
            ],
        ),
        migrations.AddField(
            model_name='compra',
            name='id_detalle_compra',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='compra.detalle_compra', verbose_name='Fecha detalle compra'),
        ),
        migrations.AddField(
            model_name='compra',
            name='id_proveedor',
